/*
 *真辉聊 v0.0.1
 *cxh1378 November 22, 2020
 *MIT license
 *view on GitHub:https://github.com/cxh1378/zhenhuiliao
 *see it in action:http://www.sosoduo.com:23333
 */
...
HiChat.prototype = {
  init: function () {
    ...
    this.socket.on('nickExisted', function () {
      document.getElementById('info').textContent =
        '!nickname is taken, Please select another one'
    })
    this.socket.on('loginSuccess', function () {
      document.title =
        '真辉聊 | ' + document.getElementById('nicknameInput').value
  ...
  _displayNewMsg: function (user, msg, color) {
    ...
    msgToDisplay.style.whiteSpace = 'pre-wrap'
    msgToDisplay.innerHTML =
      user + '<span class="timespan">(' + date + '): </span>' + msg
    // var msgToDisplaySendMsg = document.createElement('span')
    // msgToDisplaySendMsg.innerText = msg
    // msgToDisplay.appendChild(msgToDisplaySendMsg)
